...
const ValueCard = ({ index, title, icon }) => (
  <Tilt className="xs:w-[250px] w-full m-2 flex-shrink-0 flex-grow-0">
    <motion.div
    ...
    >
      <div
        ...
        style={{ width: '250px', height: '280px' }} // Fixed dimensions
      >
        <div className="flex justify-center items-center" style={{ width: '100%', height: '144px' }}>
          <img 
            src={icon} 
            alt={title} 
...
const About = () => {
  return (
    <>
      ...
      <div className="mt-20 flex flex-wrap justify-center items-center w-full gap-6 sm:gap-8 md:gap-10">
